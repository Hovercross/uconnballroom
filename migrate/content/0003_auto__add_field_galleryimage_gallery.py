...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'content_galleryimage', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['content.Gallery']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryImage.gallery'
        db.delete_column(u'content_galleryimage', 'gallery_id')
