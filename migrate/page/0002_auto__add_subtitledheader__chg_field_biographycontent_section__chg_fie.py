...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubtitledHeader'
        db.create_table(u'page_page_subtitledheader', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subtitledheader_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'page', ['SubtitledHeader'])


        # Changing field 'BiographyContent.section'
        db.alter_column(u'page_page_biographycontent', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['biographies.BiographySection']))

        # Changing field 'GalleryContent.gallery'
        db.alter_column(u'page_page_gallerycontent', 'gallery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['galleries.Gallery']))

    def backwards(self, orm):
        # Deleting model 'SubtitledHeader'
        db.delete_table(u'page_page_subtitledheader')


        # Changing field 'BiographyContent.section'
        db.alter_column(u'page_page_biographycontent', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.BiographySection']))

        # Changing field 'GalleryContent.gallery'
        db.alter_column(u'page_page_gallerycontent', 'gallery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Gallery']))
