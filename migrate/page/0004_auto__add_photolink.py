...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'page_page_photolink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('alt', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('page', self.gf('mptt.fields.TreeForeignKey')(related_name='link_to', to=orm['page.Page'])),
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photolink_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'page', ['PhotoLink'])


    def backwards(self, orm):
        # Deleting model 'PhotoLink'
        db.delete_table(u'page_page_photolink')
    ...
    models = {
        ...
        u'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'}),
