...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'mailhandler_mailinglistmessage', 'to_address')

        # Adding M2M table for field people on 'MailingListMessage'
        m2m_table_name = db.shorten_name(u'mailhandler_mailinglistmessage_people')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mailinglistmessage', models.ForeignKey(orm[u'mailhandler.mailinglistmessage'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'mailhandler_mailinglistmessage', 'to_address',
                      self.gf('django.db.models.fields.EmailField')(max_length=254),
                      keep_default=False)

        # Removing M2M table for field people on 'MailingListMessage'
        db.delete_table(db.shorten_name(u'mailhandler_mailinglistmessage_people'))
