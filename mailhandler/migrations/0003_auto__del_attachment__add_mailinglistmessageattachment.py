...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mailhandler_mailinglistmessageattachment', (
        ...
        db.send_create_signal(u'mailhandler', ['MailingListMessageAttachment'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'mailhandler_mailinglistmessageattachment')
