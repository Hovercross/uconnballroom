...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mailhandler_mailinglistmessage', 'message_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('mailhandler_mailinglistmessage', 'message_id')
    ...
    models = {
        'lists.list': {
            ...
            'people': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['registration.Person']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'mailhandler.mailsender': {
            ...
            'send_to_lists': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lists.List']", 'symmetrical': 'False', 'blank': 'True'}),
