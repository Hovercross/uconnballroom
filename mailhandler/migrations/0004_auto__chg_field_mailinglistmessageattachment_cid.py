...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailingListMessageAttachment.cid'
        db.alter_column(u'mailhandler_mailinglistmessageattachment', 'cid', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'MailingListMessageAttachment.cid'
        db.alter_column(u'mailhandler_mailinglistmessageattachment', 'cid', self.gf('django.db.models.fields.CharField')(default='', max_length=254))
