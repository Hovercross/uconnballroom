...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonEmail.created_at'
        db.add_column(u'registration_personemail', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Person.created_at'
        db.add_column(u'registration_person', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 10, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonEmail.created_at'
        db.delete_column(u'registration_personemail', 'created_at')

        # Deleting field 'Person.created_at'
        db.delete_column(u'registration_person', 'created_at')
