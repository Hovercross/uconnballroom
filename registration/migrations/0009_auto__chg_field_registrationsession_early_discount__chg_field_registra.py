...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'registration_registrationsession', 'early_discount', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'RegistrationSession.returning_discount'
        db.alter_column(u'registration_registrationsession', 'returning_discount', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'RegistrationSession.early_discount'
        db.alter_column(u'registration_registrationsession', 'early_discount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'RegistrationSession.returning_discount'
        db.alter_column(u'registration_registrationsession', 'returning_discount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
