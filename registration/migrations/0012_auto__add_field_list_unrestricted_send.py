...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'List.unrestricted_send'
        db.add_column(u'registration_list', 'unrestricted_send',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'List.unrestricted_send'
        db.delete_column(u'registration_list', 'unrestricted_send')
