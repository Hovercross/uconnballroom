...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('registration_registrationsession', 'first_club_day',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RegistrationSession.last_free_day'
        db.add_column('registration_registrationsession', 'last_free_day',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Registration', fields ['person', 'registration_session']
        db.create_unique('registration_registration', ['person_id', 'registration_session_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Registration', fields ['person', 'registration_session']
        db.delete_unique('registration_registration', ['person_id', 'registration_session_id'])

        # Deleting field 'RegistrationSession.first_club_day'
        db.delete_column('registration_registrationsession', 'first_club_day')

        # Deleting field 'RegistrationSession.last_free_day'
        db.delete_column('registration_registrationsession', 'last_free_day')
