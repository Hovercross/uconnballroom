...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('registration_list', ['slug'])

        # Adding unique constraint on 'List', fields ['name']
        db.create_unique('registration_list', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'List', fields ['name']
        db.delete_unique('registration_list', ['name'])

        # Removing unique constraint on 'List', fields ['slug']
        db.delete_unique('registration_list', ['slug'])
