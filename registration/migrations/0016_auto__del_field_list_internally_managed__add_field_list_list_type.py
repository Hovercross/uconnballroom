...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('registration_list', 'internally_managed')

        # Adding field 'List.list_type'
        db.add_column('registration_list', 'list_type',
                      self.gf('django.db.models.fields.CharField')(default='admin_list', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'List.internally_managed'
        db.add_column('registration_list', 'internally_managed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'List.list_type'
        db.delete_column('registration_list', 'list_type')
