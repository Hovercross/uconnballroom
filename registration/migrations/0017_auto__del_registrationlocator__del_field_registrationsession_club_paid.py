...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('registration_registrationlocator')

        # Deleting field 'RegistrationSession.club_paid_list'
        db.delete_column('registration_registrationsession', 'club_paid_list_id')

        # Deleting field 'RegistrationSession.team_paid_list'
        db.delete_column('registration_registrationsession', 'team_paid_list_id')

        # Deleting field 'RegistrationSession.club_unpaid_list'
        db.delete_column('registration_registrationsession', 'club_unpaid_list_id')

        # Deleting field 'RegistrationSession.team_unpaid_list'
        db.delete_column('registration_registrationsession', 'team_unpaid_list_id')


    def backwards(self, orm):
        # Adding model 'RegistrationLocator'
        db.create_table('registration_registrationlocator', (
        ...
        db.send_create_signal('registration', ['RegistrationLocator'])
