...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('registration_mailsender')
    ...
    def backwards(self, orm):
        ...
        db.create_table('registration_mailsender', (
        ...
        db.send_create_signal('registration', ['MailSender'])

        # Adding M2M table for field send_to_lists on 'MailSender'
        db.create_table('registration_mailsender_send_to_lists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mailsender', models.ForeignKey(orm['registration.mailsender'], null=False)),
            ('list', models.ForeignKey(orm['registration.list'], null=False))
        ))
        db.create_unique('registration_mailsender_send_to_lists', ['mailsender_id', 'list_id'])
