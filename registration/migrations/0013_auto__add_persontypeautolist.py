...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'registration_persontypeautolist', (
        ...
        db.send_create_signal(u'registration', ['PersonTypeAutoList'])


    def backwards(self, orm):
        # Deleting model 'PersonTypeAutoList'
        db.delete_table(u'registration_persontypeautolist')
