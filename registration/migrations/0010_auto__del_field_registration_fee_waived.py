...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Registration.fee_waived'
        db.delete_column(u'registration_registration', 'fee_waived')


    def backwards(self, orm):
        # Adding field 'Registration.fee_waived'
        db.add_column(u'registration_registration', 'fee_waived',
