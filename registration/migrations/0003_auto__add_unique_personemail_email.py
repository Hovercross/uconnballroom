...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PersonEmail', fields ['email']
        db.create_unique('registration_personemail', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'PersonEmail', fields ['email']
        db.delete_unique('registration_personemail', ['email'])
