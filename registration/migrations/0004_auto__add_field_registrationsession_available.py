...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistrationSession.available'
        db.add_column('registration_registrationsession', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegistrationSession.available'
        db.delete_column('registration_registrationsession', 'available')
    ...
    models = {
        'registration.list': {
            ...
            'included_lists': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'included_lists_rel_+'", 'to': "orm['registration.List']"}),
            'included_people': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['registration.Person']", 'symmetrical': 'False'}),
